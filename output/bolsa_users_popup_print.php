...
require_once("include/bolsa_users_popup_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "bolsa_empleo.bolsa_users_popup" );
