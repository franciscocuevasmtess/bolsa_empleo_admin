...
require_once("include/vacancia_requisito_idioma_tmp_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "bolsa_empleo.vacancia_requisito_idioma_tmp" );
