...
function checkTableName($shortTName )
{
	...
	if ("gestores_users" == $shortTName )
		return true;
	if ("vacancia" == $shortTName )
		return true;
	if ("vacancia_estado" == $shortTName )
		return true;
	if ("actividad_econ" == $shortTName )
		return true;
	if ("distritos" == $shortTName )
		return true;
	if ("city" == $shortTName )
		return true;
	if ("vacancia_dias_horas" == $shortTName )
		return true;
	if ("vacancias_dias" == $shortTName )
		return true;
	if ("vacancia_requisito_idioma" == $shortTName )
		return true;
	if ("vacancia_requisito_programa" == $shortTName )
		return true;
	if ("nivel_programa" == $shortTName )
		return true;
	if ("empresas_bolsa_sucursales" == $shortTName )
		return true;
	if ("empresa_bolsa_contactos" == $shortTName )
		return true;
	if ("tipo_contrato" == $shortTName )
		return true;
	if ("modalidad_trabajo" == $shortTName )
		return true;
	if ("country" == $shortTName )
		return true;
	if ("bolsa_sexo" == $shortTName )
		return true;
	if ("cvc_niveles_academicos" == $shortTName )
		return true;
	if ("tipo_movilidad" == $shortTName )
		return true;
	if ("tipo_registro_conducir" == $shortTName )
		return true;
	if ("persons_discap_types" == $shortTName )
		return true;
	if ("empresas_bolsa_sucursales1" == $shortTName )
		return true;
	if ("idioma" == $shortTName )
		return true;
	if ("nivel_idioma" == $shortTName )
		return true;
	if ("postulacion" == $shortTName )
		return true;
	if ("empresas_bolsa" == $shortTName )
		return true;
	if ("empresas_sucursales_types" == $shortTName )
		return true;
	if ("empresas_sucursales_types1" == $shortTName )
		return true;
	if ("empresas_sucursales_types2" == $shortTName )
		return true;
	if ("empresas_bolsa_sucursales2" == $shortTName )
		return true;
	if ("empresas_bolsa_sucursales3" == $shortTName )
		return true;
	if ("tipo_remuneracion" == $shortTName )
		return true;
	if ("programas" == $shortTName )
		return true;
	if ("feria_empleo" == $shortTName )
		return true;
	if ("vacancia_pendiente" == $shortTName )
		return true;
	if ("vacancia_tmp" == $shortTName )
		return true;
	if ("vacancia_requisito_idioma_tmp" == $shortTName )
		return true;
	if ("vacancia_requisito_programa_tmp" == $shortTName )
		return true;
	if ("vacancia_dias_horas_tmp" == $shortTName )
		return true;
	if ("empresas_bolsa_sucursales4" == $shortTName )
		return true;
	if ("empresas_bolsa1" == $shortTName )
		return true;
	if ("empresas_bolsa2" == $shortTName )
		return true;
	if ("empresas_bolsa_sucursales5" == $shortTName )
		return true;
	if ("empresa_bolsa_contactos1" == $shortTName )
		return true;
	if ("cargo" == $shortTName )
		return true;
	if ("empresa_bolsa_tipo" == $shortTName )
		return true;
	if ("empleados_dias" == $shortTName )
		return true;
	if ("bolsa_users" == $shortTName )
		return true;
	if ("seguimientos" == $shortTName )
		return true;
	if ("estado_postulacion" == $shortTName )
		return true;
	if ("postulacion_seleccionado" == $shortTName )
		return true;
	if ("postulacion_convocado" == $shortTName )
		return true;
	if ("postulacion_postulado" == $shortTName )
		return true;
	if ("postulacion_insertado" == $shortTName )
		return true;
	if ("postulacion_preseleccionado" == $shortTName )
		return true;
	if ("bolsa_users_popup" == $shortTName )
		return true;
...
function GetTablesList($pdfMode = false)
{
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.gestores_users");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.gestores_users";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.vacancia");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.vacancia";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.vacancia_estado");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.vacancia_estado";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("public.actividad_econ");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="public.actividad_econ";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("eportal.distritos");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="eportal.distritos";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("eportal.city");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.vacancia_dias_horas");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.vacancia_dias_horas";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.vacancias_dias");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.vacancias_dias";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.vacancia_requisito_idioma");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.vacancia_requisito_programa");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.vacancia_requisito_programa";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.nivel_programa");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.nivel_programa";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.empresas_bolsa_sucursales");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.empresas_bolsa_sucursales";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.empresa_bolsa_contactos");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.empresa_bolsa_contactos";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.tipo_contrato");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.tipo_contrato";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.modalidad_trabajo");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("eportal.country");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.cvc_niveles_academicos");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.cvc_niveles_academicos";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.tipo_movilidad");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.tipo_movilidad";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.tipo_registro_conducir");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.tipo_registro_conducir";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("eportal.persons_discap_types");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="eportal.persons_discap_types";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.empresas_bolsa_sucursales1");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.empresas_bolsa_sucursales1";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.idioma");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.idioma";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.nivel_idioma");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.nivel_idioma";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.postulacion");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.postulacion";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.empresas_bolsa");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.empresas_bolsa";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("eportal.empresas_sucursales_types");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="eportal.empresas_sucursales_types";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("eportal.empresas_sucursales_types1");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="eportal.empresas_sucursales_types1";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("eportal.empresas_sucursales_types2");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="eportal.empresas_sucursales_types2";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.empresas_bolsa_sucursales2");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.empresas_bolsa_sucursales2";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.empresas_bolsa_sucursales3");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.empresas_bolsa_sucursales3";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.tipo_remuneracion");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.programas");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.programas";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.feria_empleo");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.feria_empleo";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("vacancia_pendiente");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="vacancia_pendiente";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.vacancia_tmp");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.vacancia_tmp";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.vacancia_requisito_idioma_tmp");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.vacancia_requisito_idioma_tmp";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.vacancia_requisito_programa_tmp");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.vacancia_requisito_programa_tmp";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.vacancia_dias_horas_tmp");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.vacancia_dias_horas_tmp";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.empresas_bolsa_sucursales4");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.empresas_bolsa_sucursales4";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.empresas_bolsa1");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.empresas_bolsa1";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.empresas_bolsa2");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.empresas_bolsa2";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.empresas_bolsa_sucursales5");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.empresas_bolsa_sucursales5";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.empresa_bolsa_contactos1");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.empresa_bolsa_contactos1";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.cargo");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.cargo";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.empresa_bolsa_tipo");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.empresa_bolsa_tipo";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("mtess.empleados_dias");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="mtess.empleados_dias";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.bolsa_users");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.bolsa_users";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.seguimientos");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.seguimientos";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.postulacion_seleccionado");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.postulacion_seleccionado";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.postulacion_convocado");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.postulacion_convocado";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.postulacion_postulado");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.postulacion_postulado";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.postulacion_insertado");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="bolsa_empleo.postulacion_insertado";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.postulacion_preseleccionado");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.bolsa_users_popup");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("bolsa_empleo.postulacion_importar_planilla");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
...
function GetUserPermissionsStatic( $table )
{
	...
	$extraPerm = "";
	if( $table=="bolsa_empleo.gestores_users" )
	{
		if( $sUserGroup=="<Guest>" )
		{
						return "".$extraPerm;
...
//	default permissions
	...
	if( $table=="bolsa_empleo.vacancia" )
	{
		if( $sUserGroup=="<Guest>" )
		{
						return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="bolsa_empleo.vacancia_estado" )
	{
		if( $sUserGroup=="<Guest>" )
		{
						return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="public.actividad_econ" )
	{
		if( $sUserGroup=="<Guest>" )
		{
						return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="bolsa_empleo.vacancia_dias_horas" )
	{
		if( $sUserGroup=="<Guest>" )
		{
						return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="bolsa_empleo.vacancias_dias" )
	{
		if( $sUserGroup=="<Guest>" )
		{
						return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="bolsa_empleo.vacancia_requisito_idioma" )
	{
		if( $sUserGroup=="<Guest>" )
		{
						return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="bolsa_empleo.vacancia_requisito_programa" )
	{
		if( $sUserGroup=="<Guest>" )
		{
						return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="bolsa_empleo.nivel_programa" )
	{
		if( $sUserGroup=="<Guest>" )
		{
						return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="bolsa_empleo.empresas_bolsa_sucursales" )
	{
		if( $sUserGroup=="<Guest>" )
		{
						return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="bolsa_empleo.empresa_bolsa_contactos" )
	{
		if( $sUserGroup=="<Guest>" )
		{
						return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="bolsa_empleo.tipo_contrato" )
	{
		if( $sUserGroup=="<Guest>" )
		{
						return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="bolsa_empleo.modalidad_trabajo" )
	{
		if( $sUserGroup=="<Guest>" )
		{
						return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="bolsa_empleo.cvc_niveles_academicos" )
	{
		if( $sUserGroup=="<Guest>" )
		{
						return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="bolsa_empleo.tipo_movilidad" )
	{
		if( $sUserGroup=="<Guest>" )
		{
						return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="bolsa_empleo.tipo_registro_conducir" )
	{
		if( $sUserGroup=="<Guest>" )
		{
						return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="eportal.persons_discap_types" )
	{
		if( $sUserGroup=="<Guest>" )
		{
						return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="bolsa_empleo.empresas_bolsa_sucursales1" )
	{
		if( $sUserGroup=="<Guest>" )
		{
						return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="bolsa_empleo.nivel_idioma" )
	{
		if( $sUserGroup=="<Guest>" )
		{
						return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="bolsa_empleo.postulacion" )
	{
		if( $sUserGroup=="<Guest>" )
		{
						return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="bolsa_empleo.empresas_bolsa" )
	{
		if( $sUserGroup=="<Guest>" )
		{
						return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="eportal.empresas_sucursales_types" )
	{
		if( $sUserGroup=="<Guest>" )
		{
						return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="eportal.empresas_sucursales_types1" )
	{
		if( $sUserGroup=="<Guest>" )
		{
						return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="eportal.empresas_sucursales_types2" )
	{
		if( $sUserGroup=="<Guest>" )
		{
						return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="bolsa_empleo.empresas_bolsa_sucursales2" )
	{
		if( $sUserGroup=="<Guest>" )
		{
						return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="bolsa_empleo.empresas_bolsa_sucursales3" )
	{
		if( $sUserGroup=="<Guest>" )
		{
						return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="bolsa_empleo.programas" )
	{
		if( $sUserGroup=="<Guest>" )
		{
						return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="bolsa_empleo.feria_empleo" )
	{
		if( $sUserGroup=="<Guest>" )
		{
						return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="bolsa_empleo.vacancia_tmp" )
	{
		if( $sUserGroup=="<Guest>" )
		{
						return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="bolsa_empleo.vacancia_requisito_idioma_tmp" )
	{
		if( $sUserGroup=="<Guest>" )
		{
						return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="bolsa_empleo.vacancia_requisito_programa_tmp" )
	{
		if( $sUserGroup=="<Guest>" )
		{
						return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="bolsa_empleo.vacancia_dias_horas_tmp" )
	{
		if( $sUserGroup=="<Guest>" )
		{
						return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="bolsa_empleo.empresas_bolsa_sucursales4" )
	{
		if( $sUserGroup=="<Guest>" )
		{
						return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="bolsa_empleo.empresas_bolsa1" )
	{
		if( $sUserGroup=="<Guest>" )
		{
						return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="bolsa_empleo.empresas_bolsa2" )
	{
		if( $sUserGroup=="<Guest>" )
		{
						return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="bolsa_empleo.empresas_bolsa_sucursales5" )
	{
		if( $sUserGroup=="<Guest>" )
		{
						return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="bolsa_empleo.empresa_bolsa_contactos1" )
	{
		if( $sUserGroup=="<Guest>" )
		{
						return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="bolsa_empleo.empresa_bolsa_tipo" )
	{
		if( $sUserGroup=="<Guest>" )
		{
						return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="bolsa_empleo.bolsa_users" )
	{
		if( $sUserGroup=="<Guest>" )
		{
						return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="bolsa_empleo.seguimientos" )
	{
		if( $sUserGroup=="<Guest>" )
		{
						return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="bolsa_empleo.postulacion_seleccionado" )
	{
		if( $sUserGroup=="<Guest>" )
		{
						return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="bolsa_empleo.postulacion_convocado" )
	{
		if( $sUserGroup=="<Guest>" )
		{
						return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="bolsa_empleo.postulacion_postulado" )
	{
		if( $sUserGroup=="<Guest>" )
		{
						return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="bolsa_empleo.postulacion_insertado" )
	{
		if( $sUserGroup=="<Guest>" )
		{
						return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="bolsa_empleo.postulacion_preseleccionado" )
	{
		if( $sUserGroup=="<Guest>" )
		{
						return "S".$extraPerm;
...
//	default permissions
	...
	if( $table=="bolsa_empleo.bolsa_users_popup" )
	{
		if( $sUserGroup=="<Guest>" )
		{
						return "S".$extraPerm;
