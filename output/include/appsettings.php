...
$custom_labels["Spanish"] = array();
	$custom_labels["Spanish"]['DISPLAYING'] = "Mostrando %first% - %last% de %total% postulados convocados";
	$custom_labels["Spanish"]['DISPLAYING1'] = "Mostrando %first% - %last% de %total% postulados seleccionados";
	$custom_labels["Spanish"]['DISPLAYING2'] = "Mostrando %first% - %last% de %total% Registros";
	$custom_labels["Spanish"]['DISPLAYING3'] = "Mostrando %first% - %last% de %total% Registros";
	$custom_labels["Spanish"]['PROFILE'] = "Perfil de Usuario";
	$custom_labels["Spanish"]['DISPLAYING4'] = "( %total% )";
	$custom_labels["Spanish"]['DISPLAYING5'] = "Mostrando %first% - %last% de %total% postulados preseleccionados";
	$custom_labels["Spanish"]['DISPLAYING6'] = "Mostrando %first% - %last% de %total% postulantes";
...
$globalSettings["strFromEmail"] = "admin@mtess.gov.py";
...
$globalSettings["ProjectLogo"]["Spanish"] = "<img src=\"images/imgob23/emplea_b.png\" style=\"max-width: 100%;  height:4vh;\" class=\"image wp-image-113  attachment-full size-full\" alt=\"Tabicón del Gobierno y Trabajo\" decoding=\"async\" >";
 ...
 * DEPRECATED
 */
$cLoginTable = "bolsa_empleo.gestores_users";
...
$globalSettings["usersDatasourceTable"] = "bolsa_empleo.gestores_users";


$globalSettings["jwtSecret"] = "yMNOTtI2gYJEvvCyXIhF";
...
$projectBuildKey = "2498_1738950542";
$wizardBuildKey = "41974";
$projectBuildNumber = "2498";
...
$tableCaptions["Spanish"]["bolsa_empleo_gestores_users"] = "Gestores Users";
$tableCaptions["Spanish"]["bolsa_empleo_vacancia"] = "Ofertas de Empleo";
$tableCaptions["Spanish"]["bolsa_empleo_vacancia_estado"] = "Vacancia Estado";
$tableCaptions["Spanish"]["public_actividad_econ"] = "Actividad Econ";
$tableCaptions["Spanish"]["eportal_distritos"] = "Distritos";
$tableCaptions["Spanish"]["eportal_city"] = "City";
$tableCaptions["Spanish"]["bolsa_empleo_vacancia_dias_horas"] = "Vacancia Dias Horas";
$tableCaptions["Spanish"]["bolsa_empleo_vacancias_dias"] = "Vacancias Dias";
$tableCaptions["Spanish"]["bolsa_empleo_vacancia_requisito_idioma"] = "Vacancia Requisito Idioma";
$tableCaptions["Spanish"]["bolsa_empleo_vacancia_requisito_programa"] = "Vacancia Requisito Programa";
$tableCaptions["Spanish"]["bolsa_empleo_nivel_programa"] = "Nivel Programa";
$tableCaptions["Spanish"]["bolsa_empleo_empresas_bolsa_sucursales"] = "Empresas Bolsa Sucursales";
$tableCaptions["Spanish"]["bolsa_empleo_empresa_bolsa_contactos"] = "Empresa Bolsa Contactos";
$tableCaptions["Spanish"]["bolsa_empleo_tipo_contrato"] = "Tipo Contrato";
$tableCaptions["Spanish"]["bolsa_empleo_modalidad_trabajo"] = "Modalidad Trabajo";
$tableCaptions["Spanish"]["eportal_country"] = "Country";
$tableCaptions["Spanish"]["bolsa_empleo_bolsa_sexo"] = "Bolsa Sexo";
$tableCaptions["Spanish"]["bolsa_empleo_cvc_niveles_academicos"] = "Cvc Niveles Academicos";
$tableCaptions["Spanish"]["bolsa_empleo_tipo_movilidad"] = "Tipo Movilidad";
$tableCaptions["Spanish"]["bolsa_empleo_tipo_registro_conducir"] = "Tipo Registro Conducir";
$tableCaptions["Spanish"]["eportal_persons_discap_types"] = "Persons Discap Types";
$tableCaptions["Spanish"]["bolsa_empleo_empresas_bolsa_sucursales1"] = "Empresas Bolsa Sucursales1";
$tableCaptions["Spanish"]["bolsa_empleo_idioma"] = "Idioma";
$tableCaptions["Spanish"]["bolsa_empleo_nivel_idioma"] = "Nivel Idioma";
$tableCaptions["Spanish"]["bolsa_empleo_postulacion"] = "Postulantes";
$tableCaptions["Spanish"]["bolsa_empleo_empresas_bolsa"] = "Empresas Bolsa";
$tableCaptions["Spanish"]["eportal_empresas_sucursales_types"] = "Empresas Sucursales Types";
$tableCaptions["Spanish"]["eportal_empresas_sucursales_types1"] = "Empresas Sucursales";
$tableCaptions["Spanish"]["eportal_empresas_sucursales_types2"] = "Empresas Sucursales Types2";
$tableCaptions["Spanish"]["bolsa_empleo_empresas_bolsa_sucursales2"] = "Empresas Bolsa Sucursales2";
$tableCaptions["Spanish"]["bolsa_empleo_empresas_bolsa_sucursales3"] = "Empresas Bolsa Sucursales3";
$tableCaptions["Spanish"]["bolsa_empleo_tipo_remuneracion"] = "Tipo Remuneracion";
$tableCaptions["Spanish"]["bolsa_empleo_programas"] = "Programas";
$tableCaptions["Spanish"]["bolsa_empleo_feria_empleo"] = "Feria de Oferta";
$tableCaptions["Spanish"]["vacancia_pendiente"] = "Vacancia Pendiente";
$tableCaptions["Spanish"]["bolsa_empleo_vacancia_tmp"] = "Vacancia Tmp";
$tableCaptions["Spanish"]["bolsa_empleo_vacancia_requisito_idioma_tmp"] = "Vacancia Requisito Idioma Tmp";
$tableCaptions["Spanish"]["bolsa_empleo_vacancia_requisito_programa_tmp"] = "Vacancia Requisito Programa Tmp";
$tableCaptions["Spanish"]["bolsa_empleo_vacancia_dias_horas_tmp"] = "Vacancia Dias Horas Tmp";
$tableCaptions["Spanish"]["bolsa_empleo_empresas_bolsa_sucursales4"] = "Bolsa Sucursales4";
$tableCaptions["Spanish"]["bolsa_empleo_empresas_bolsa1"] = "Empresas Bolsa1";
$tableCaptions["Spanish"]["bolsa_empleo_empresas_bolsa2"] = "Empresas Bolsa2";
$tableCaptions["Spanish"]["bolsa_empleo_empresas_bolsa_sucursales5"] = "Empresas Bolsa Sucursales5";
$tableCaptions["Spanish"]["bolsa_empleo_empresa_bolsa_contactos1"] = "Empresa Bolsa Contactos1";
$tableCaptions["Spanish"]["bolsa_empleo_cargo"] = "Cargo";
$tableCaptions["Spanish"]["bolsa_empleo_empresa_bolsa_tipo"] = "Empresa Bolsa Tipo";
$tableCaptions["Spanish"]["mtess_empleados_dias"] = "Empleados Dias";
$tableCaptions["Spanish"]["bolsa_empleo_bolsa_users"] = "Bolsa Users";
$tableCaptions["Spanish"]["bolsa_empleo_seguimientos"] = "Seguimientos";
$tableCaptions["Spanish"]["bolsa_empleo_estado_postulacion"] = "Estado Postulacion";
$tableCaptions["Spanish"]["bolsa_empleo_postulacion_seleccionado"] = "Postulacion Seleccionado";
$tableCaptions["Spanish"]["bolsa_empleo_postulacion_convocado"] = "Postulacion Convocado";
$tableCaptions["Spanish"]["bolsa_empleo_postulacion_postulado"] = "Postulacion Postulado";
$tableCaptions["Spanish"]["bolsa_empleo_postulacion_insertado"] = "Postulacion Insertado";
