...
Runner.lang.customlabels = {
	...
	// custom labels
	CUSTOM_LABEL_DISPLAYING: 'Mostrando %first% - %last% de %total% postulados convocados',
	CUSTOM_LABEL_DISPLAYING1: 'Mostrando %first% - %last% de %total% postulados seleccionados',
	CUSTOM_LABEL_DISPLAYING2: 'Mostrando %first% - %last% de %total% Registros',
	CUSTOM_LABEL_DISPLAYING3: 'Mostrando %first% - %last% de %total% Registros',
	CUSTOM_LABEL_PROFILE: 'Perfil de Usuario',
	CUSTOM_LABEL_DISPLAYING4: '( %total% )',
	CUSTOM_LABEL_DISPLAYING5: 'Mostrando %first% - %last% de %total% postulados preseleccionados',
	CUSTOM_LABEL_DISPLAYING6: 'Mostrando %first% - %last% de %total% postulantes'
};