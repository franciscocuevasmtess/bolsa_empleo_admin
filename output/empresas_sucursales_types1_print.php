...
require_once("include/empresas_sucursales_types1_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "eportal.empresas_sucursales_types1" );
