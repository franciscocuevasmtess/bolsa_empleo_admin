...
require_once("include/postulacion_convocado_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "bolsa_empleo.postulacion_convocado" );
