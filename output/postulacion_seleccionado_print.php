...
require_once("include/postulacion_seleccionado_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "bolsa_empleo.postulacion_seleccionado" );
