...
require_once("include/bolsa_gestores_users_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "bolsa_empleo.bolsa_gestores_users" );
