...
//				$this->strLabel = $params['name'];
	...
	protected function isProjectDB()
	{
		...
		if("bolsa_empleo.gestores_users" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.vacancia" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.vacancia_estado" == $this->chrt_array['tables'][0])
			return true;
		if("public.actividad_econ" == $this->chrt_array['tables'][0])
			return true;
		if("eportal.distritos" == $this->chrt_array['tables'][0])
			return true;
		if("eportal.city" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.vacancia_dias_horas" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.vacancias_dias" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.vacancia_requisito_idioma" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.vacancia_requisito_programa" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.nivel_programa" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.empresas_bolsa_sucursales" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.empresa_bolsa_contactos" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.tipo_contrato" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.modalidad_trabajo" == $this->chrt_array['tables'][0])
			return true;
		if("eportal.country" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.bolsa_sexo" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.cvc_niveles_academicos" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.tipo_movilidad" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.tipo_registro_conducir" == $this->chrt_array['tables'][0])
			return true;
		if("eportal.persons_discap_types" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.empresas_bolsa_sucursales" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.idioma" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.nivel_idioma" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.postulacion" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.empresas_bolsa" == $this->chrt_array['tables'][0])
			return true;
		if("eportal.empresas_sucursales_types" == $this->chrt_array['tables'][0])
			return true;
		if("eportal.empresas_sucursales_types" == $this->chrt_array['tables'][0])
			return true;
		if("eportal.empresas_sucursales_types" == $this->chrt_array['tables'][0])
		...
		if("bolsa_empleo.tipo_remuneracion" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.programas" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.feria_empleo" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.vacancia" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.vacancia_tmp" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.vacancia_requisito_idioma_tmp" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.vacancia_requisito_programa_tmp" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.vacancia_dias_horas_tmp" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.empresas_bolsa_sucursales" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.empresas_bolsa" == $this->chrt_array['tables'][0])
		...
		if("bolsa_empleo.empresa_bolsa_contactos" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.cargo" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.empresa_bolsa_tipo" == $this->chrt_array['tables'][0])
			return true;
		if("mtess.empleados_dias" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.bolsa_users" == $this->chrt_array['tables'][0])
			return true;
		if("bolsa_empleo.seguimientos" == $this->chrt_array['tables'][0])
			return true;
