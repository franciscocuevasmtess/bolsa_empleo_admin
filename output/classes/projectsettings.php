	...
	*/
	...
	public static function getForLogin()
	{
		return !!Security::dbProvider()
			? new ProjectSettings("bolsa_empleo.gestores_users", PAGE_LIST)
			: null;
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "bolsa_empleo.gestores_users" ] = array( "url" => "gestores_users", "type" => 0 );
	$projectEntitiesReverse[ "gestores_users" ] = "bolsa_empleo.gestores_users";
	$projectEntities[ "bolsa_empleo.vacancia" ] = array( "url" => "vacancia", "type" => 0 );
	$projectEntitiesReverse[ "vacancia" ] = "bolsa_empleo.vacancia";
	$projectEntities[ "bolsa_empleo.vacancia_estado" ] = array( "url" => "vacancia_estado", "type" => 0 );
	$projectEntitiesReverse[ "vacancia_estado" ] = "bolsa_empleo.vacancia_estado";
	$projectEntities[ "public.actividad_econ" ] = array( "url" => "actividad_econ", "type" => 0 );
	$projectEntitiesReverse[ "actividad_econ" ] = "public.actividad_econ";
	$projectEntities[ "eportal.distritos" ] = array( "url" => "distritos", "type" => 0 );
	$projectEntitiesReverse[ "distritos" ] = "eportal.distritos";
	$projectEntities[ "eportal.city" ] = array( "url" => "city", "type" => 0 );
	$projectEntitiesReverse[ "city" ] = "eportal.city";
	$projectEntities[ "bolsa_empleo.vacancia_dias_horas" ] = array( "url" => "vacancia_dias_horas", "type" => 0 );
	$projectEntitiesReverse[ "vacancia_dias_horas" ] = "bolsa_empleo.vacancia_dias_horas";
	$projectEntities[ "bolsa_empleo.vacancias_dias" ] = array( "url" => "vacancias_dias", "type" => 0 );
	$projectEntitiesReverse[ "vacancias_dias" ] = "bolsa_empleo.vacancias_dias";
	$projectEntities[ "bolsa_empleo.vacancia_requisito_idioma" ] = array( "url" => "vacancia_requisito_idioma", "type" => 0 );
	$projectEntitiesReverse[ "vacancia_requisito_idioma" ] = "bolsa_empleo.vacancia_requisito_idioma";
	$projectEntities[ "bolsa_empleo.vacancia_requisito_programa" ] = array( "url" => "vacancia_requisito_programa", "type" => 0 );
	$projectEntitiesReverse[ "vacancia_requisito_programa" ] = "bolsa_empleo.vacancia_requisito_programa";
	$projectEntities[ "bolsa_empleo.nivel_programa" ] = array( "url" => "nivel_programa", "type" => 0 );
	$projectEntitiesReverse[ "nivel_programa" ] = "bolsa_empleo.nivel_programa";
	$projectEntities[ "bolsa_empleo.empresas_bolsa_sucursales" ] = array( "url" => "empresas_bolsa_sucursales", "type" => 0 );
	$projectEntitiesReverse[ "empresas_bolsa_sucursales" ] = "bolsa_empleo.empresas_bolsa_sucursales";
	$projectEntities[ "bolsa_empleo.empresa_bolsa_contactos" ] = array( "url" => "empresa_bolsa_contactos", "type" => 0 );
	$projectEntitiesReverse[ "empresa_bolsa_contactos" ] = "bolsa_empleo.empresa_bolsa_contactos";
	$projectEntities[ "bolsa_empleo.tipo_contrato" ] = array( "url" => "tipo_contrato", "type" => 0 );
	$projectEntitiesReverse[ "tipo_contrato" ] = "bolsa_empleo.tipo_contrato";
	$projectEntities[ "bolsa_empleo.modalidad_trabajo" ] = array( "url" => "modalidad_trabajo", "type" => 0 );
	$projectEntitiesReverse[ "modalidad_trabajo" ] = "bolsa_empleo.modalidad_trabajo";
	$projectEntities[ "eportal.country" ] = array( "url" => "country", "type" => 0 );
	$projectEntitiesReverse[ "country" ] = "eportal.country";
	...
	$projectEntities[ "bolsa_empleo.cvc_niveles_academicos" ] = array( "url" => "cvc_niveles_academicos", "type" => 0 );
	$projectEntitiesReverse[ "cvc_niveles_academicos" ] = "bolsa_empleo.cvc_niveles_academicos";
	$projectEntities[ "bolsa_empleo.tipo_movilidad" ] = array( "url" => "tipo_movilidad", "type" => 0 );
	$projectEntitiesReverse[ "tipo_movilidad" ] = "bolsa_empleo.tipo_movilidad";
	$projectEntities[ "bolsa_empleo.tipo_registro_conducir" ] = array( "url" => "tipo_registro_conducir", "type" => 0 );
	$projectEntitiesReverse[ "tipo_registro_conducir" ] = "bolsa_empleo.tipo_registro_conducir";
	$projectEntities[ "eportal.persons_discap_types" ] = array( "url" => "persons_discap_types", "type" => 0 );
	$projectEntitiesReverse[ "persons_discap_types" ] = "eportal.persons_discap_types";
	$projectEntities[ "bolsa_empleo.empresas_bolsa_sucursales1" ] = array( "url" => "empresas_bolsa_sucursales1", "type" => 1 );
	$projectEntitiesReverse[ "empresas_bolsa_sucursales1" ] = "bolsa_empleo.empresas_bolsa_sucursales1";
	$projectEntities[ "bolsa_empleo.idioma" ] = array( "url" => "idioma", "type" => 0 );
	$projectEntitiesReverse[ "idioma" ] = "bolsa_empleo.idioma";
	$projectEntities[ "bolsa_empleo.nivel_idioma" ] = array( "url" => "nivel_idioma", "type" => 0 );
	$projectEntitiesReverse[ "nivel_idioma" ] = "bolsa_empleo.nivel_idioma";
	$projectEntities[ "bolsa_empleo.postulacion" ] = array( "url" => "postulacion", "type" => 0 );
	$projectEntitiesReverse[ "postulacion" ] = "bolsa_empleo.postulacion";
	$projectEntities[ "bolsa_empleo.empresas_bolsa" ] = array( "url" => "empresas_bolsa", "type" => 1 );
	$projectEntitiesReverse[ "empresas_bolsa" ] = "bolsa_empleo.empresas_bolsa";
	$projectEntities[ "eportal.empresas_sucursales_types" ] = array( "url" => "empresas_sucursales_types", "type" => 1 );
	$projectEntitiesReverse[ "empresas_sucursales_types" ] = "eportal.empresas_sucursales_types";
	$projectEntities[ "eportal.empresas_sucursales_types1" ] = array( "url" => "empresas_sucursales_types1", "type" => 1 );
	$projectEntitiesReverse[ "empresas_sucursales_types1" ] = "eportal.empresas_sucursales_types1";
	$projectEntities[ "eportal.empresas_sucursales_types2" ] = array( "url" => "empresas_sucursales_types2", "type" => 1 );
	$projectEntitiesReverse[ "empresas_sucursales_types2" ] = "eportal.empresas_sucursales_types2";
	$projectEntities[ "bolsa_empleo.empresas_bolsa_sucursales2" ] = array( "url" => "empresas_bolsa_sucursales2", "type" => 1 );
	$projectEntitiesReverse[ "empresas_bolsa_sucursales2" ] = "bolsa_empleo.empresas_bolsa_sucursales2";
	$projectEntities[ "bolsa_empleo.empresas_bolsa_sucursales3" ] = array( "url" => "empresas_bolsa_sucursales3", "type" => 1 );
	$projectEntitiesReverse[ "empresas_bolsa_sucursales3" ] = "bolsa_empleo.empresas_bolsa_sucursales3";
	...
	$projectEntities[ "bolsa_empleo.programas" ] = array( "url" => "programas", "type" => 0 );
	$projectEntitiesReverse[ "programas" ] = "bolsa_empleo.programas";
	$projectEntities[ "bolsa_empleo.feria_empleo" ] = array( "url" => "feria_empleo", "type" => 0 );
	$projectEntitiesReverse[ "feria_empleo" ] = "bolsa_empleo.feria_empleo";
	$projectEntities[ "vacancia_pendiente" ] = array( "url" => "vacancia_pendiente", "type" => 1 );
	$projectEntitiesReverse[ "vacancia_pendiente" ] = "vacancia_pendiente";
	$projectEntities[ "bolsa_empleo.vacancia_tmp" ] = array( "url" => "vacancia_tmp", "type" => 0 );
	$projectEntitiesReverse[ "vacancia_tmp" ] = "bolsa_empleo.vacancia_tmp";
	$projectEntities[ "bolsa_empleo.vacancia_requisito_idioma_tmp" ] = array( "url" => "vacancia_requisito_idioma_tmp", "type" => 0 );
	$projectEntitiesReverse[ "vacancia_requisito_idioma_tmp" ] = "bolsa_empleo.vacancia_requisito_idioma_tmp";
	$projectEntities[ "bolsa_empleo.vacancia_requisito_programa_tmp" ] = array( "url" => "vacancia_requisito_programa_tmp", "type" => 0 );
	$projectEntitiesReverse[ "vacancia_requisito_programa_tmp" ] = "bolsa_empleo.vacancia_requisito_programa_tmp";
	$projectEntities[ "bolsa_empleo.vacancia_dias_horas_tmp" ] = array( "url" => "vacancia_dias_horas_tmp", "type" => 0 );
	$projectEntitiesReverse[ "vacancia_dias_horas_tmp" ] = "bolsa_empleo.vacancia_dias_horas_tmp";
	$projectEntities[ "bolsa_empleo.empresas_bolsa_sucursales4" ] = array( "url" => "empresas_bolsa_sucursales4", "type" => 1 );
	$projectEntitiesReverse[ "empresas_bolsa_sucursales4" ] = "bolsa_empleo.empresas_bolsa_sucursales4";
	$projectEntities[ "bolsa_empleo.empresas_bolsa1" ] = array( "url" => "empresas_bolsa1", "type" => 1 );
	$projectEntitiesReverse[ "empresas_bolsa1" ] = "bolsa_empleo.empresas_bolsa1";
	$projectEntities[ "bolsa_empleo.empresas_bolsa2" ] = array( "url" => "empresas_bolsa2", "type" => 1 );
	$projectEntitiesReverse[ "empresas_bolsa2" ] = "bolsa_empleo.empresas_bolsa2";
	$projectEntities[ "bolsa_empleo.empresas_bolsa_sucursales5" ] = array( "url" => "empresas_bolsa_sucursales5", "type" => 1 );
	$projectEntitiesReverse[ "empresas_bolsa_sucursales5" ] = "bolsa_empleo.empresas_bolsa_sucursales5";
	$projectEntities[ "bolsa_empleo.empresa_bolsa_contactos1" ] = array( "url" => "empresa_bolsa_contactos1", "type" => 1 );
	$projectEntitiesReverse[ "empresa_bolsa_contactos1" ] = "bolsa_empleo.empresa_bolsa_contactos1";
	$projectEntities[ "bolsa_empleo.cargo" ] = array( "url" => "cargo", "type" => 0 );
	$projectEntitiesReverse[ "cargo" ] = "bolsa_empleo.cargo";
	$projectEntities[ "bolsa_empleo.empresa_bolsa_tipo" ] = array( "url" => "empresa_bolsa_tipo", "type" => 0 );
	$projectEntitiesReverse[ "empresa_bolsa_tipo" ] = "bolsa_empleo.empresa_bolsa_tipo";
	$projectEntities[ "mtess.empleados_dias" ] = array( "url" => "empleados_dias", "type" => 0 );
	$projectEntitiesReverse[ "empleados_dias" ] = "mtess.empleados_dias";
	$projectEntities[ "bolsa_empleo.bolsa_users" ] = array( "url" => "bolsa_users", "type" => 0 );
	$projectEntitiesReverse[ "bolsa_users" ] = "bolsa_empleo.bolsa_users";
	$projectEntities[ "bolsa_empleo.seguimientos" ] = array( "url" => "seguimientos", "type" => 0 );
	$projectEntitiesReverse[ "seguimientos" ] = "bolsa_empleo.seguimientos";
	...
	$projectEntities[ "bolsa_empleo.postulacion_seleccionado" ] = array( "url" => "postulacion_seleccionado", "type" => 1 );
	$projectEntitiesReverse[ "postulacion_seleccionado" ] = "bolsa_empleo.postulacion_seleccionado";
	$projectEntities[ "bolsa_empleo.postulacion_convocado" ] = array( "url" => "postulacion_convocado", "type" => 1 );
	$projectEntitiesReverse[ "postulacion_convocado" ] = "bolsa_empleo.postulacion_convocado";
	$projectEntities[ "bolsa_empleo.postulacion_postulado" ] = array( "url" => "postulacion_postulado", "type" => 1 );
	$projectEntitiesReverse[ "postulacion_postulado" ] = "bolsa_empleo.postulacion_postulado";
	$projectEntities[ "bolsa_empleo.postulacion_insertado" ] = array( "url" => "postulacion_insertado", "type" => 1 );
	$projectEntitiesReverse[ "postulacion_insertado" ] = "bolsa_empleo.postulacion_insertado";
	$projectEntities[ "bolsa_empleo.postulacion_preseleccionado" ] = array( "url" => "postulacion_preseleccionado", "type" => 1 );
	$projectEntitiesReverse[ "postulacion_preseleccionado" ] = "bolsa_empleo.postulacion_preseleccionado";
	$projectEntities[ "bolsa_empleo.bolsa_users_popup" ] = array( "url" => "bolsa_users_popup", "type" => 1 );
