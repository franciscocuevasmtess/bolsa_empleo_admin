...
$totalRecordsQuery = "SELECT COUNT(*) AS total FROM bolsa_empleo.ocupacion_puesto_clasificaciones $searchCondition";
...
$query = "SELECT id_ocu_puest_clasi as id, descripcion as text FROM bolsa_empleo.ocupacion_puesto_clasificaciones $searchCondition ORDER BY descripcion LIMIT $records_per_page OFFSET $offset";
